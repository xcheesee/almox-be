...
@section('cabecalho')
    @include('layouts.cabecalho', ['titulo' => 'Novo(a) Responsável', 'rota' => 'cadaux-responsaveis_emails'])
@endsection
...
<div class="container containerTabela justify-content-center">
    ...
    <div class="container">
        {!! Form::open(array('route' => 'cadaux-responsaveis_emails-store','method'=>'POST', 'autocomplete'=>"off")) !!}
