...
with pd.ExcelFile(r'items_serralheria.xlsx') as xls:
...
f = open('insertSerralheria.sql', 'w')

# db = mariadb.connect(user='root', host="localhost", password='', database='svma_listas_sharepoint', charset='utf8')
# cursor = db.cursor()

#depois de inserir os itens de elétrica, devemos chegar em 426 na chave primária
id_item = 427
